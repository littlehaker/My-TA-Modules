...
keys[not OSX and 'ad' or 'cdel'] = utils.delete_word
...
-- Tools.
keys[not OSX and 'ax' or 'me'] = gui.command_entry.focus
...
-- Adeptsense.
keys[not OSX and 'ac' or 'aesc'] = m_textadept.adeptsense.complete_symbol
